...
public class Talk {
	...
	private Shader windowShader, splitShader, nameShader, textShader;
	...
	public Talk(String talkName, String talkText) {
		...
		splitShader = new LinearGradient(0, 0, 800, 0, Color.argb(255, 0, 255, 255), Color.argb(0, 0, 255, 255), Shader.TileMode.REPEAT);
