...
public class TiledLayer {
	...
	public void outOfBounds() {
		if (x > 0) {
			x = 0;
		} else if (x < GameView.designScreenWidth - tiledCols * width) {
			x = GameView.designScreenWidth - tiledCols * width;
		}
		if (y > 0) {
			y = 0;
		} else if (y < GameView.designScreenHeight - tiledRows * height) {
			y = GameView.designScreenHeight - tiledRows * height;
		}
	}
